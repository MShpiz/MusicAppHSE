...
@Composable
fun AllPlaylistListScreen(
    navController: NavController,
    viewModel: PlaylistListScreenViewModel = hiltViewModel()
) {
    Scaffold(
        topBar = {
            TopBar(
                ...
                screenName = stringResource(id = R.string.all_playlists)
            )
        },
        ...
        Column(
            ...
            PlaylistList(playLists = viewModel.mutableStateList, navController = navController)
        }
    }
}